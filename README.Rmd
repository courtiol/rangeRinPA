...
You can install rangeRinPA by clicking on the green button above with the label **"Code"** and then on **Download ZIP** (do not unzip it!).
...
You can also install rangeRinPA as any other R package stored on GitHub using:
