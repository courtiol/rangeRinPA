...
We start by comparing EVI to the 2 other ecological indexes:
...
We start by comparing SPI to the 2 other ecological indexes:

```{r SPI_EVI plot, fig.height=8, fig.width=8, cache=TRUE}
data_rangers %>%
  ggplot() +
  aes(y = SPI, x = EVI, label = countryname, size = area_country, colour = country_UN_continent) +
  #geom_text_repel(min.segment.length = 0, nudge_x = 0, nudge_y = 0, force = 0.03, force_pull = 2, seed = 123) +
  geom_text() +
  coord_fixed(xlim = c(0, 100), ylim = c(0, 100)) +
  scale_size_continuous(trans = "sqrt", guide = "none", range = c(3, 7)) +
...
```{r SPI_EPI plot, fig.height=8, fig.width=8, cache=TRUE}
data_rangers %>%
  ggplot() +
  aes(y = SPI, x = EPI_2020, label = countryname, size = area_country, colour = country_UN_continent) +
  #geom_text_repel(min.segment.length = 0, nudge_x = 0, nudge_y = 0, force = 0.03, force_pull = 2, seed = 123) +
  geom_text() +
  coord_fixed(xlim = c(0, 100), ylim = c(0, 100)) +
  scale_size_continuous(trans = "sqrt", guide = "none", range = c(3, 7)) +
...
We start by comparing EPI to the 2 other ecological indexes:

```{r EPI_EVI plot, fig.height=8, fig.width=8, cache=TRUE}
data_rangers %>%
  ggplot() +
  aes(y = EPI_2020, x = EVI, label = countryname, size = area_country, colour = country_UN_continent) +
  # geom_text_repel(min.segment.length = 0, nudge_x = 0, nudge_y = 0, force = 0.03, force_pull = 2, seed = 123) +
  geom_text() +
  coord_fixed(xlim = c(20, 80), ylim = c(20, 80)) +
  scale_size_continuous(trans = "sqrt", guide = "none", range = c(3, 7)) +
